...
const Navbar = () => {
    ...
    return <div className="navbar py-7 flex justify-between">
        <div className="logo">
    ...
    md:-translate-x-0 -top-10 opacity-0 md:opacity-100 bg-white/30 backdrop-blur-md p-4 rounded-br-2xl rounded-bl-2xl md:bg-transparent
